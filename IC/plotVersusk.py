...
if __name__ == "__main__":
    ...
    fig = plt.figure()
    d1plt, = plt.semilogy(list(data1.keys()), list(data1.values()), 'r--')
    d2plt, = plt.semilogy(list(data2.keys()), list(data2.values()), 'b--')
    d3plt, = plt.semilogy(list(data3.keys()), list(data3.values()), 'g--')
    ...
    fig = plt.figure()
    d1plt, = plt.plot(list(data1.keys()), list(data1.values()), 'r--')
    d2plt, = plt.plot(list(data2.keys()), list(data2.values()), 'b--')
    d3plt, = plt.plot(list(data3.keys()), list(data3.values()), 'g--')
    plt.xlabel("Seed set size k")
